...
import { createPurchaseOrderAction } from '../actions/purchases.actions'
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-5xl mx-auto bg-card p-6 rounded-2xl border border-border/40 shadow-sm">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="expected_date">Fecha Esperada de Entrega</Label>
          <Input
            id="expected_date"
            type="date"
            value={expectedDate}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-border/40">
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            placeholder="Términos de pago, detalles de entrega, etc..."
            rows={3}
          />
        </div>
