      ...
      if (React.isValidElement(child)) {
        ...
        if (childElement.props.children) {
          ...
          if (typeof childElement.props.children === "string") {
            text = childElement.props.children
          } else if (Array.isArray(childElement.props.children)) {
            text = childElement.props.children.join("")
          }
          if (text) {
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          {...props}
        >
          <div className="p-2 border-b border-border/40 sticky top-0 bg-popover z-10 flex items-center gap-2">
