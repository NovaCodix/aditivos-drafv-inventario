...
async function UsersContent() {
  ...
  if (error) {
    return (
      <div className="text-center py-12 border border-destructive/20 bg-destructive/5 rounded-2xl text-destructive text-sm font-semibold m-4">
  ...
  return (
    <div className="overflow-x-auto">
      ...
      {/* Pagination */}
      <DataTablePagination totalItems={profiles?.length ?? 0} />
    </div>
  )
}
